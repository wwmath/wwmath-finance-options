C     albrecher2007/trap-form-agrees-Im-1-target
...
C     g[1]
      Z005=(((R002-(X(8)*X(6)*X(2)*(0.0D0,1.0D0)))+Z004)/((R002-(X(8)*X(
     &6)*X(2)*(0.0D0,1.0D0)))-Z004))
C     C[1]
      Z006=((X(1)*X(2)*(0.0D0,1.0D0)*X(3))+((R001/(X(6)**2))*((((R002-(X
     &(8)*X(6)*X(2)*(0.0D0,1.0D0)))+Z004)*X(3))-(2.0D0*LOG(((1.0D0-(Z005
     &*EXP((Z004*X(3)))))/(1.0D0-Z005)))))))
C     D[1]
      Z007=((((R002-(X(8)*X(6)*X(2)*(0.0D0,1.0D0)))+Z004)/(X(6)**2))*((1
     &.0D0-EXP((Z004*X(3))))/(1.0D0-(Z005*EXP((Z004*X(3)))))))
C     x
      R008 = LOG(X(10))
C     f[1]
