C     albrecher2007/quantlib-AnalyticHestonEngine-trap
...
C     gt[1]
      Z006=(((R003-(X(9)*X(7)*XV*(0.0D0,1.0D0)))+(-Z005))/((R003-(X(9)*X
     &(7)*XV*(0.0D0,1.0D0)))-(-Z005)))
C     Ct[1]
      Z007=((X(3)*XV*(0.0D0,1.0D0)*X(4))+((R002/(X(7)**2))*((((R003-(X(9
     &)*X(7)*XV*(0.0D0,1.0D0)))+(-Z005))*X(4))-(2.0D0*LOG(((1.0D0-(Z006*
     &EXP(((-Z005)*X(4)))))/(1.0D0-Z006)))))))
C     Dt[1]
      Z008=((((R003-(X(9)*X(7)*XV*(0.0D0,1.0D0)))+(-Z005))/(X(7)**2))*((
     &1.0D0-EXP(((-Z005)*X(4))))/(1.0D0-(Z006*EXP(((-Z005)*X(4)))))))
C     x
      R009 = LOG(X(1))
C     ft[1]
...
C     gt[2]
      Z019=(((R016-(X(9)*X(7)*XV*(0.0D0,1.0D0)))+(-Z018))/((R016-(X(9)*X
     &(7)*XV*(0.0D0,1.0D0)))-(-Z018)))
C     Ct[2]
      Z020=((X(3)*XV*(0.0D0,1.0D0)*X(4))+((R015/(X(7)**2))*((((R016-(X(9
     &)*X(7)*XV*(0.0D0,1.0D0)))+(-Z018))*X(4))-(2.0D0*LOG(((1.0D0-(Z019*
     &EXP(((-Z018)*X(4)))))/(1.0D0-Z019)))))))
C     Dt[2]
      Z021=((((R016-(X(9)*X(7)*XV*(0.0D0,1.0D0)))+(-Z018))/(X(7)**2))*((
     &1.0D0-EXP(((-Z018)*X(4))))/(1.0D0-(Z019*EXP(((-Z018)*X(4)))))))
C     x
      R022 = LOG(X(1))
C     ft[2]
