...
export class Harness {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        HarnessFinalization.unregister(this);
        return ptr;
    }
     ...
     * @param {any} exports
     */
    add_engine(name, exports) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.harness_add_engine(this.__wbg_ptr, ptr0, len0, exports);
        if (ret[1]) {
     ...
     */
    engine_names() {
        const ret = wasm.harness_engine_names(this.__wbg_ptr);
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
    constructor() {
        const ret = wasm.harness_new();
        this.__wbg_ptr = ret >>> 0;
        HarnessFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('conformance_host_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
