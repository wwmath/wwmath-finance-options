...
extern "C" __attribute__((export_name("heston_step")))
void heston_step(
    double s,
    double v,
    double dt,
...
extern "C" __attribute__((export_name("bates_step")))
void bates_step(
    double s,
    double v,
    double dt,
...
extern "C" __attribute__((export_name("sabr_step")))
void sabr_step(
    double f,
    double alpha,
    double dt,
    ...
    double* output)
{
    ...
    const double pow_log_k = (static_cast<double>((pow_log_hx >> 20)) - 1023.0);
    ...
    const double pow_2k = ww_from_bits((static_cast<unsigned long long>((pow_k + 1023.0)) << 52));
